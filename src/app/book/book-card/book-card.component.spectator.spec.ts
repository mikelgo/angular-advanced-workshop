    ...
    describe('template', () => {
        ...
        describe('When content is passed', () => {
            it('renders the content', () => {
                ...
                expect(spectator.query('[data-test=book-card-title]')?.innerHTML).toContain(book.title);
            });
        });

        describe('When no content is passed', () => {
            it('renders "n/a"', () => {
                expect(spectator.query('[data-test=book-card-title]')?.innerHTML).toContain('n/a');
            });
        });
    });
});
